...
CREATE ALIAS GeomFromText for "geodb.GeoDB.ST_GeomFromEWKT";
...
create domain county as char(1) default 'B' check value in('B', 'K', 'Q', 'M', 'S'); 
...
INSERT INTO `location` (`borough`, `sign_number`, `main_street`, `from_street`, `to_street`, `orientation`, `from_lat`, `from_lng`, `to_lat`, `to_lng`, `center_lat`, `center_lng`, `length`, `validated`, `offset_lat`, `center_geo`, `offset_lng`)
VALUES
	('B' , 'P-004958' , 'RANDALL AVENUE' , 'FAILE STREET' , 'COSTER STREET' , 'N' , 40.8122541 , -73.8858952 , 40.8121307 , -73.8867966 , 40.8121924 , -73.8863459 , 0.0009098074081949518 , 1 , 0 , GeomFromText('POINT(40.8121924 -73.8863459)') , 0) ,
	('K' , 'S-214406' , 'STILLWELL AVENUE' , 'AVENUE P' , 'KINGS HIGHWAY' , 'W' , 40.6072554 , -73.987268 , 40.60603649999999 , -73.98703189999999 , 40.606645949999994 , -73.98714995 , 0.0012415556451620166 , 1 , 0 , GeomFromText('POINT(40.606645949999994 -73.98714995)') , 0) ,
	('K' , 'P-234103' , 'BRIGHTON BEACH AVENUE' , 'BRIGHTON 4 STREET' , 'BRIGHTON 3 STREET' , 'N' , 40.5772774 , -73.9633395 , 40.5770855 , -73.9642472 , 40.57718145 , -73.96379335 , 0.0009277633857817685 , 1 , 0 , GeomFromText('POINT(40.57718145 -73.96379335)') , 0) ,
	('K' , 'P-234101' , 'BRIGHTON BEACH AVENUE' , 'BRIGHTON 1 PLACE' , 'BRIGHTON 1 STREET' , 'N' , 40.5767088 , -73.9659964 , 40.5764614 , -73.9670876 , 40.5765851 , -73.966542 , 0.0011188941862436987 , 1 , 0 , GeomFromText('POINT(40.5765851 -73.966542)') , 0) ,
    ('K' , 'P-229242' , 'BRIGHTON 1 PLACE' , 'BRIGHTON BEACH AVENUE' , 'BRIGHTON 1 STREET' , 'E' , 40.5767088 , -73.9659964 , 40.5773834 , -73.96700229999999 , 40.577046100000004 , -73.96649934999999 , 0.001211164716294124 , 1 , 0 , GeomFromText('POINT(40.577046100000004 -73.96649934999999)') , 0) ,
	('K' , 'P-229243' , 'BRIGHTON BEACH AVENUE' , 'BRIGHTON 1 ROAD' , 'BRIGHTON 1 PLACE' , 'S' , 40.5764988 , -73.9664402 , 40.5767088 , -73.9659964 , 40.5766038 , -73.9662183 , 0.0004909770259366081 , 1 , 0 , GeomFromText('POINT(40.5766038 -73.9662183)') , 0) ,
    ('K' , 'P-229244' , 'BRIGHTON 1 ROAD' , 'BRIGHTON BEACH AVENUE' , 'BRIGHTWATER COURT' , 'E' , 40.5764988 , -73.9664402 , 40.5754918 , -73.9666111 , 40.5759953 , -73.96652565 , 0.0010213989475238478 , 1 , 0 , GeomFromText('POINT(40.5759953 -73.96652565)') , 0) ,
	('K' , 'S-061674' , 'BRIGHTON COURT' , 'BRIGHTON 1 ROAD' , 'BRIGHTON 1 STREET' , 'N' , 40.5764988 , -73.9664402 , 40.5783354 , -73.96678229999999 , 40.577417100000005 , -73.96661125 , 0.0018681894898505186 , 1 , 0 , GeomFromText('POINT(40.577417100000005 -73.96661125)') , 0) ,
	('K' , 'S-958671' , 'BRIGHTON 1 PLACE' , 'BRIGHTON BEACH AVENUE' , 'BRIGHTON 1 STREET' , 'W' , 40.5767088 , -73.9659964 , 40.578016 , -73.9668603 , 40.5773624 , -73.96642835 , 0.0015668742929783373 , 1 , 0 , GeomFromText('POINT(40.5773624 -73.96642835)') , 0) ,
	('K' , 'P-234112' , 'BRIGHTON BEACH AVENUE' , 'BRIGHTON 1 STREET' , 'OCEAN PARKWAY' , 'N' , 40.5764614 , -73.9670876 , 40.5764123 , -73.9682752 , 40.57643685 , -73.9676814 , 0.0011886145590503832 , 1 , 0 , GeomFromText('POINT(40.57643685 -73.9676814)') , 0) ,
	('K' , 'P-234113' , 'BRIGHTON BEACH AVENUE' , 'BRIGHTON 5 STREET' , 'BRIGHTON 4 STREET' , 'N' , 40.5774713 , -73.9623709 , 40.5772774 , -73.9633395 , 40.57737435 , -73.9628552 , 0.000987817376853585 , 1 , 0 , GeomFromText('POINT(40.57737435 -73.9628552)') , 0) ,
	('K' , 'P-234114' , 'BRIGHTON 1 STREET' , 'BRIGHTON BEACH AVENUE' , 'OCEAN VIEW AVENUE' , 'W' , 40.5764614 , -73.9670876 , 40.5786226 , -73.96674879999999 , 40.577542 , -73.9669182 , 0.0021875947705231272 , 1 , 0 , GeomFromText('POINT(40.577542 -73.9669182)') , 0) ,
	('K' , 'P-234116' , 'BRIGHTON BEACH AVENUE' , 'OCEAN PARKWAY' , 'BRIGHTON 1 ROAD' , 'S' , 40.5764123 , -73.9682752 , 40.5764988 , -73.9664402 , 40.576455550000006 , -73.9673577 , 0.001837037628901385 , 1 , 0 , GeomFromText('POINT(40.576455550000006 -73.9673577)') , 0) ,
	('K' , 'P-234119' , '63 STREET' , '19 AVENUE' , '18 AVENUE' , 'S' , 40.619013 , -73.986854 , 40.620303 , -73.988993 , 40.619658 , -73.9879235 , 0.002497883303917888 , 1 , 0 , GeomFromText('POINT(40.619658 -73.9879235)') , 0) ,
	('K' , 'P-234120' , '61 STREET' , '19 AVENUE' , '18 AVENUE' , 'S' , 40.620131 , -73.985693 , 40.621435 , -73.98785099999999 , 40.620783 , -73.986772 , 0.00252138454028121 , 1 , 0 , GeomFromText('POINT(40.620783 -73.986772)') , 0) ,
	('K' , 'P-234121' , 'NEW UTRECHT AVENUE' , '70 STREET' , '71 STREET' , 'W' , 40.6197349 , -73.9988381 , 40.6189503 , -73.9990689 , 40.619342599999996 , -73.9989535 , 0.0008178421608061509 , 1 , 0 , GeomFromText('POINT(40.619342599999996 -73.9989535)') , 0) ,
	('K' , 'P-234179' , 'FLATBUSH AVENUE' , 'PROSPECT PLACE' , '7 AVENUE' , 'W' , 40.678639 , -73.97350899999999 , 40.6779961 , -73.97305109999999 , 40.67831755 , -73.97328005 , 0.0007892989420965733 , 1 , 0 , GeomFromText('POINT(40.67831755 -73.97328005)') , 0) ,
	('K' , 'P-234194' , '4 AVENUE' , '37 STREET' , '36 STREET' , 'E' , 40.6537148 , -74.0049336 , 40.6542671 , -74.0043493 , 40.65399095 , -74.00464145000001 , 0.0008040160321752086 , 1 , 0 , GeomFromText('POINT(40.65399095 -74.00464145000001)') , 0) ,
	('K' , 'P-234578' , 'CORTELYOU ROAD' , 'EAST 17 STREET' , 'EAST 16 STREET' , 'N' , 40.6420192 , -73.9626477 , 40.6416128 , -73.9635564 , 40.641816 , -73.96310205 , 0.0009954379187051277 , 1 , 0 , GeomFromText('POINT(40.641816 -73.96310205)') , 0) ,
	('K' , 'P-234583' , 'CORTELYOU ROAD' , 'STRATFORD ROAD' , 'CONEY ISLAND AVENUE' , 'N' , 40.6396561 , -73.967917 , 40.639018 , -73.968722 , 40.63933705 , -73.9683195 , 0.0010272276330024284 , 1 , 0 , GeomFromText('POINT(40.63933705 -73.9683195)') , 0) ,
	('K' , 'P-234684' , 'NEW UTRECHT AVENUE' , '72 STREET' , '73 STREET' , 'W' , 40.6181893 , -73.9992996 , 40.61740289999999 , -73.99951070000002 , 40.61779609999999 , -73.99940515 , 0.0008142408550434457 , 1 , 0 , GeomFromText('POINT(40.61779609999999 -73.99940515)') , 0) ,
	('K' , 'P-234686' , 'BRIGHTON 1 STREET' , 'BRIGHTON BEACH AVENUE' , 'BRIGHTON 1 PLACE' , 'E' , 40.5764614 , -73.9670876 , 40.5773834 , -73.96700229999999 , 40.5769224 , -73.96704495 , 0.0009259374114953141 , 1 , 0 , GeomFromText('POINT(40.5769224 -73.96704495)') , 0) ,
	('K' , 'P-234974' , 'FLATBUSH AVENUE' , 'FOSTER AVENUE' , 'EAST 26 STREET' , 'W' , 40.638423 , -73.95358259999999 , 40.6369031 , -73.951972 , 40.63766305 , -73.9527773 , 0.0022145266695144904 , 1 , 0 , GeomFromText('POINT(40.63766305 -73.9527773)') , 0) ,
	('K' , 'P-235267' , 'SMITH STREET' , '2 STREET' , 'CARROLL STREET' , 'E' , 40.679482 , -73.995373 , 40.6802 , -73.994889 , 40.679840999999996 , -73.995131 , 0.0008658983774086111 , 1 , 0 , GeomFromText('POINT(40.679840999999996 -73.995131)') , 0) ,
	('K' , 'P-235275' , 'PITKIN AVENUE' , 'CHESTER STREET' , 'ROCKAWAY AVENUE' , 'S' , 40.669543 , -73.91166199999999 , 40.6696789 , -73.9107456 , 40.66961095 , -73.9112038 , 0.0009264220258555355 , 1 , 0 , GeomFromText('POINT(40.66961095 -73.9112038)') , 0) ,
	('K' , 'P-235276' , 'PITKIN AVENUE' , 'SARATOGA AVENUE' , 'STRAUSS STREET' , 'S' , 40.6687038 , -73.91732669999999 , 40.6688404 , -73.9163464 , 40.6687721 , -73.91683655 , 0.0009897715140320023 , 1 , 0 , GeomFromText('POINT(40.6687721 -73.91683655)') , 0) ,
	('K' , 'P-235277' , 'PITKIN AVENUE' , 'HERZL STREET' , 'AMBOY STREET' , 'S' , 40.6689736 , -73.9154331 , 40.6691149 , -73.9145204 , 40.66904425 , -73.91497675 , 0.0009235729424360452 , 1 , 0 , GeomFromText('POINT(40.66904425 -73.91497675)') , 0) ,
	('K' , 'P-235278' , 'PITKIN AVENUE' , 'ROCKAWAY AVENUE' , 'CHESTER STREET' , 'N' , 40.6696789 , -73.9107456 , 40.669543 , -73.91166199999999 , 40.66961095 , -73.9112038 , 0.0009264220258555355 , 1 , 0 , GeomFromText('POINT(40.66961095 -73.9112038)') , 0) ,
	('K' , 'P-235279' , 'PITKIN AVENUE' , 'OSBORN STREET' , 'WATKINS STREET' , 'S' , 40.6699779 , -73.9088919 , 40.6583446 , -73.904985 , 40.66416125 , -73.90693845 , 0.012271818793480672 , 1 , 0 , GeomFromText('POINT(40.66416125 -73.90693845)') , 0) ,
	('K' , 'P-235280' , 'PITKIN AVENUE' , 'THOMAS BOYLAND STREET' , 'BRISTOL STREET' , 'S' , 40.6692495 , -73.9135787 , 40.6694003 , -73.91262549999999 , 40.6693249 , -73.9131021 , 0.0009650548585562799 , 1 , 0 , GeomFromText('POINT(40.6693249 -73.9131021)') , 0) ,
	('K' , 'P-235281' , 'BELMONT AVENUE' , 'THATFORD AVENUE' , 'OSBORN STREET' , 'N' , 40.6685491 , -73.9094798 , 40.6686863 , -73.90856289999999 , 40.6686177 , -73.90902134999999 , 0.000927108111286026 , 1 , 0 , GeomFromText('POINT(40.6686177 -73.90902134999999)') , 0) ,
	('K' , 'P-235283' , 'BELMONT AVENUE' , 'THATFORD AVENUE' , 'OSBORN STREET' , 'S' , 40.6685491 , -73.9094798 , 40.6686863 , -73.90856289999999 , 40.6686177 , -73.90902134999999 , 0.000927108111286026 , 1 , 0 , GeomFromText('POINT(40.6686177 -73.90902134999999)') , 0) ,
	('K' , 'P-235288' , 'PITKIN AVENUE' , 'OSBORN STREET' , 'THATFORD STREET' , 'N' , 40.6699779 , -73.9088919 , 40.6698293 , -73.90981359999999 , 40.6699036 , -73.90935275 , 0.0009336020833225712 , 1 , 0 , GeomFromText('POINT(40.6699036 -73.90935275)') , 0) ,
	('K' , 'P-235291' , 'PITKIN AVENUE' , 'BRISTOL STREET' , 'THOMAS BOYLAND STREET' , 'N' , 40.6694003 , -73.91262549999999 , 40.6692495 , -73.9135787 , 40.6693249 , -73.9131021 , 0.0009650548585562799 , 1 , 0 , GeomFromText('POINT(40.6693249 -73.9131021)') , 0) ,
	('K' , 'P-235292' , 'PITKIN AVENUE' , 'AMBOY STREET' , 'HERZL STREET' , 'N' , 40.6691149 , -73.9145204 , 40.6689736 , -73.9154331 , 40.66904425 , -73.91497675 , 0.0009235729424360452 , 1 , 0 , GeomFromText('POINT(40.66904425 -73.91497675)') , 0) ,
	('K' , 'P-235305' , 'PITKIN AVENUE' , 'STRAUSS STREET' , 'SARATOGA AVENUE' , 'N' , 40.6688404 , -73.9163464 , 40.6687038 , -73.91732669999999 , 40.6687721 , -73.91683655 , 0.0009897715140320023 , 1 , 0 , GeomFromText('POINT(40.6687721 -73.91683655)') , 0) ,
	('K' , 'P-235306' , 'PITKIN AVENUE' , 'LEGION STREET' , 'GRAFTON STREET' , 'N' , 40.6685571 , -73.9182873 , 40.6684224 , -73.9192011 , 40.66848975 , -73.91874419999999 , 0.0009236744718713193 , 1 , 0 , GeomFromText('POINT(40.66848975 -73.91874419999999)') , 0) ,
	('K' , 'S-113531' , 'STILLWELL AVENUE' , 'BAY PARKWAY' , 'AVENUE P' , 'W' , 40.6081648 , -73.9873492 , 40.6072554 , -73.987268 , 40.6077101 , -73.9873086 , 0.0009130179625807724 , 1 , 0 , GeomFromText('POINT(40.6077101 -73.9873086)') , 0);
...
VALUES
	...
	('K','P-234101',1,0,'Curb Line',NULL),
	('K','P-234101',2,7,'Building Line',NULL),
	('K','P-234101',3,87,'BUS STOP SIGN (BUS & HANDICAP SYMBOLS) NO STANDING W/ SINGLE ARROW','E'),
	('K','P-234101',4,87,'M 18 LTD (12\"X 6\") 8 STREET 4 AVENUE (16\"X 6\") (ROUTE DESTINATION PANEL 032\"X 06\")(USE AS EXAMPLE FOR DIFFERENT LOCATION)',NULL),
	('K','P-234101',5,87,'14 STREET & UNION SQ (BOTTOM LOCATION PANEL)(USE AS EXAMPLE FOR DIFFERENT LOCATION)',NULL),
	('K','P-234101',6,103,'NO PARKING (SANITATION BROOM SYMBOL) 8-8:30AM EXCEPT SUN <----> (SUPERSEDES SP-182C)',NULL),
	('K','P-234101',7,103,'2 HOUR PARKING 8:30AM-7PM EXCEPT SUNDAY <---->',NULL),
	('K','P-234101',8,103,'PAY AT MUNI-METER W/ SINGLE ARROW NYC PARKING CARD AVAILABLE (PARKING CARDS LOGO) FOR INFORMATION VISIT WWW.NYC.GOV/DOT OR CALL 311 (DO NOT USE AS PER J.S-K 10/23/09)','W'),
	('K','P-234101',9,213,'PAY AT MUNI-METER W/ SINGLE ARROW NYC PARKING CARD AVAILABLE (PARKING CARDS LOGO) FOR INFORMATION VISIT WWW.NYC.GOV/DOT OR CALL 311 (DO NOT USE AS PER J.S-K 10/23/09)','E'),
	('K','P-234101',10,248,'NO PARKING ANYTIME (SINGLE ARROW)(SUPERSEDES R7-40 DON''TUSE R7-40)','W'),
	('K','P-234101',11,248,'NO PARKING (SANITATION BROOM SYMBOL) 8-8:30AM EXCEPT SUN W/ SIGNLE ARROW (SUPERSEDES SP-182CA)','E'),
	('K','P-234101',12,248,'2 HOUR PARKING 8:30AM-7PM EXCEPT SUNDAY <---->','E'),
	('K','P-234101',13,291,'Building Line',NULL),
	('K','P-234101',14,306,'Curb Line',NULL),
	('K','P-229242',1,0,'Curb Line',NULL),
	('K','P-229242',2,21,'Building Line',NULL),
	('K','P-229242',3,64,'NO PARKING (SANITATION BROOM SYMBOL) 8-9:30AM TUES & FRI<---->',NULL),
	('K','P-229242',4,64,'METERS ARE NOT IN EFFECT ABOVE TIMES (RIDER)',NULL),
	('K','P-229242',5,64,'2 HOUR PARKING 9AM-7PM EXCEPT SUNDAY <----->',NULL),
	('K','P-229242',6,64,'PAY AT MUNI-METER LOCATED AROUND THE CORNER W/ SINGLE ARROW','S'),
	('K','P-229242',7,64,'NYC PARKING CARD AVAILABLE (PARKING CARDS LOGO) FOR INFORMATION VISIT WWW.NYC.GOV/DOT OR CALL 311 (SUPERSEDES SP-186D',NULL),
	('K','P-229242',8,119,'NO PARKING (SANITATION BROOM SYMBOL) 8-9:30AM TUES & FRI<---->',NULL),
	('K','P-229242',9,119,'METERS ARE NOT IN EFFECT ABOVE TIMES (RIDER)',NULL),
	('K','P-229242',10,119,'2 HOUR PARKING 9AM-7PM EXCEPT SUNDAY W/ SINGLE ARROW','S'),
	('K','P-229242',11,119,'PAY AT MUNI-METER LOCATED AROUND THE CORNER W/ SINGLE ARROW','S'),
	('K','P-229242',12,119,'NYC PARKING CARD AVAILABLE (PARKING CARDS LOGO) FOR INFORMATION VISIT WWW.NYC.GOV/DOT OR CALL 311 (SUPERSEDES SP-186D',NULL),
	('K','P-229242',13,182,'NO PARKING (SANITATION BROOM SYMBOL) 8-9:30AM TUES & FRI<---->',NULL),
	('K','P-229242',14,316,'NO PARKING (SANITATION BROOM SYMBOL) 8-9:30AM TUES & FRI<---->',NULL),
	('K','P-229242',15,480,'NO PARKING (SANITATION BROOM SYMBOL) 8-9:30AM TUES & FRI<---->',NULL),
	('K','P-229242',16,487,'Building Line',NULL),
	('K','P-229242',17,487,'Curb Line',NULL),
	('K','P-229243',1,0,'Curb Line',NULL),
	('K','P-229243',2,10,'Building Line',NULL),
	('K','P-229243',3,21,'NO PARKING (SANITATION BROOM SYMBOL) 7:30-8AM EXCEPT SUN <----->',NULL),
	('K','P-229243',4,21,'2 HOUR PARKING 8AM-7PM EXCEPT SUNDAY',NULL),
	('K','P-229243',5,21,'PAY AT MUNI-METER <-----> (SUPERSEDES SP-160D)',NULL),
	('K','P-229243',6,107,'NO PARKING (SANITATION BROOM SYMBOL) 7:30-8AM EXCEPT SUN <----->',NULL),
	('K','P-229243',7,107,'2 HOUR PARKING 8AM-7PM EXCEPT SUNDAY',NULL),
	('K','P-229243',8,107,'NYC PARKING CARD AVAILABLE (PARKING CARDS LOGO) FOR INFORMATION VISIT WWW.NYC.GOV/DOT OR CALL 311 (SUPERSEDES SP-186D',NULL),
	('K','P-229243',9,127,'Building Line',NULL),
	('K','P-229243',10,137,'Curb Line',NULL),
	('K','P-229244',1,0,'Curb Line',NULL),
	('K','P-229244',2,20,'Building Line',NULL),
	('K','P-229244',3,98,'NO PARKING (SANITATION BROOM SYMBOL) 8-9:30AM TUES & FRI<---->',NULL),
	('K','P-229244',4,98,'METERS ARE NOT IN EFFECT ABOVE TIMES (RIDER)',NULL),
	('K','P-229244',5,98,'2 HOUR PARKING 9AM-7PM EXCEPT SUNDAY W/ SINGLE ARROW','N'),
	('K','P-229244',6,98,'PAY AT MUNI-METER LOCATED AROUND THE CORNER W/ SINGLE ARROW','N'),
	('K','P-229244',7,98,'NYC PARKING CARD AVAILABLE (PARKING CARDS LOGO) FOR INFORMATION VISIT WWW.NYC.GOV/DOT OR CALL 311 (SUPERSEDES SP-186D',NULL),
	('K','P-229244',8,172,'NO PARKING (SANITATION BROOM SYMBOL) 8-9:30AM TUES & FRI<---->',NULL),
	('K','P-229244',9,310,'NO PARKING (SANITATION BROOM SYMBOL) 8-9:30AM TUES & FRI<---->',NULL),
	('K','P-229244',10,330,'Building Line',NULL),
	('K','P-229244',11,341,'Curb Line',NULL),
	('K','S-061674',1,0,'Building Line',NULL),
	('K','S-061674',2,80,'NO STANDING (SINGLE ARROW) HANDICAP BUS SYMBOL (4 ROUTES) SUPERSEDED BY R7-61A DATED 3/25/92','E'),
	('K','S-061674',3,178,'NO PARKING (SANITATION BROOM SYMBOL) 8AM-9AM EXCEPT SUNDAY <----> (SUPERSEDED BY SP-156C DATED 1-22-98)',NULL),
	('K','S-061674',4,178,'1 HOUR PARKING 9AM-7PM EXCEPT SUNDAY',NULL),
	('K','S-061674',5,178,'$.10 PER 1/2 HR',NULL),
	('K','S-061674',6,244,'NO PARKING (SANITATION BROOM SYMBOL) 8AM-9AM EXCEPT SUNDAY <----> (SUPERSEDED BY SP-156C DATED 1-22-98)','E'),
	('K','S-061674',7,244,'1 HOUR PARKING 9AM-7PM EXCEPT SUNDAY (ARROW)','E'),
	('K','S-061674',8,244,'$.10 PER 1/2 HR',NULL),
	('K','S-061674',9,290,'NO PARKING ANYTIME (ARROW) (SUPERSEDED BY R7-40RA DON''T USE R7-40A)','E'),
	('K','S-061674',10,289,'Property Line',NULL),
	('K','S-958671',1,0,'Curb Line',NULL),
	('K','S-958671',2,21,'Building Line',NULL),
	('K','S-958671',3,42,'NO PARKING ANYTIME <----> (SUPERSEDES R7-40 DON''T USE --R7-40)',NULL),
	('K','S-958671',4,185,'NO PARKING ANYTIME <----> (SUPERSEDES R7-40 DON''T USE --R7-40)',NULL),
	('K','S-958671',5,335,'NO PARKING ANYTIME <----> (SUPERSEDES R7-40 DON''T USE --R7-40)',NULL),
	('K','S-958671',6,485,'NO PARKING ANYTIME <----> (SUPERSEDES R7-40 DON''T USE --R7-40)',NULL),
	('K','S-958671',7,523,'Property Line',NULL),
	('K','S-958671',8,535,'Curb Line',NULL),
    ('K','S-214406',1,0,'Curb Line',NULL),
    ('K','S-214406',2,19,'Property Line',NULL),
    ('K','S-214406',3,50,'NO STANDING ANYTIME (SINGLE ARROW) (REPLACES R7-20RA)','N'),
    ('K','S-214406',4,50,'NO PARKING (SANITATION BROOM SYMBOL) 11:30AM TO 1PM THURS W/SINGLE ARROW','S'),
    ('K','S-214406',5,96,'NO PARKING ANYTIME (SINGLE ARROW)(SUPERSEDES R7-40 DON''TUSE R7-40)','S'),
    ('K','S-214406',6,96,'AMBULETTE',NULL),
    ('K','S-214406',7,136,'NO PARKING ANYTIME (SINGLE ARROW)(SUPERSEDES R7-40 DON''TUSE R7-40)','N'),
    ('K','S-214406',8,136,'AMBULETTE',NULL),
    ('K','S-214406',9,136,'NO PARKING (SANITATION BROOM SYMBOL) 11:30AM TO 1PM THURS W/SINGLE ARROW','S'),
    ('K','S-214406',10,280,'NO PARKING (SANITATION BROOM SYMBOL) 11:30AM TO 1PM THURS W/SINGLE ARROW','N'),
    ('K','S-214406',11,362,'BUS STOP SIGN (BUS & HANDICAP SYMBOLS) NO STANDING <----->',NULL),
    ('K','S-214406',12,362,'M 18 LTD (12\"X 6\") 8 STREET 4 AVENUE (16\"X 6\") (ROUTE DESTINATION PANEL 032\"X 06\")(USE AS EXAMPLE FOR DIFFERENT LOCATION)',NULL),
    ('K','S-214406',13,362,'14 STREET & UNION SQ (BOTTOM LOCATION PANEL)(USE AS EXAMPLE FOR DIFFERENT LOCATION)',NULL),
    ('K','S-214406',14,365,'Property Line',NULL),
    ('K','S-214406',15,377,'Curb Line',NULL);
